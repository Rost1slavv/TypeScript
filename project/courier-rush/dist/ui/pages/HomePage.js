...
export function HomePage() {
    ...
    const description = createElement("p", "hero-text launcher-description", "Ретро-гра про швидкі доставки містом. Обирай режим, забирай посилки зі складу, доставляй їх клієнтам, уникай аварій і набирай очки для рейтингу.");
    ...
    const canvas = createElement("canvas", "home-city-canvas");
    ...
    classicCard.append(createElement("h2", "", "Класика"), createElement("p", "", "Самостійно обирай замовлення, плануй маршрут, забирай посилки зі складу та доставляй їх клієнтам."), createElement("span", "mode-tag", "4 хвилини"));
    const arcadeCard = createElement("article", "retro-card game-mode-card");
    arcadeCard.append(createElement("h2", "", "Аркада 90с"), createElement("p", "", "Отримуй випадкові замовлення автоматично та змагайся за максимальну кількість балів за півтори хвилини."), createElement("span", "mode-tag", "на очки"));
